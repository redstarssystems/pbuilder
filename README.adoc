image:https://img.shields.io/clojars/v/org.rssys/pbuilder.svg[Travis-CI,link=https://clojars.org/org.rssys/pbuilder]
image:https://circleci.com/gh/redstarssystems/rsbox/tree/develop.svg?style=svg[Circle-CI,link=https://circleci.com/gh/redstarssystems/rsbox/tree/develop]
...
----
     ...
     :pbuilder {:extra-deps {org.rssys/pbuilder {:mvn/version "0.1.8"}}
                :jvm-opts   []
...
----
{
 ...
 :artifact-version            "0.1.8-SNAPSHOT"
