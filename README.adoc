...
Project builder is a high level wrapper for https://github.com/EwenG/badigeon[Badigeon], 
...
Add file `pbuild.edn` to project root. Structure for `pbuild.edn` is shown below.
