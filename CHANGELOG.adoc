...
* aero lib: support to set artifact version via #env ARTIFACT_VERSION environment variable
* support for war files building 

Changed:

* updated sources of badigeon up to 1.0 (now Badigeon is used as dependency)
